...
| 🔌 Провайдеры | Настройка API ключей и провайдеров |
| 📊 Статистика | Аналитика использования токенов по моделям |
| 📈 Расходы | График финансовых затрат по дням |

## 🔑 Поддерживаемые провайдеры

| Провайдер | Валюта | Особенности |
|-----------|:------:|-------------|
| OpenRouter | $ | 200+ моделей (GPT-4, Claude, Gemini и др.) |
| VSEGPT | ₽ | Российский агрегатор AI-моделей |

## 📊 Как собирается статистика

- Токены — из поля tokens модели ChatMessage
- Стоимость — из поля cost
